...
export default function RaporPage() {
  ...
  useEffect(() => {
    startTransition(async () => {
      const [rolAtamalar, imzaAtma, imzaAtanan, gunlukTalepYaratma, gunlukImzaAtma] = await Promise.all([
      ...
      <div className='flex flex-col items-center justify-center w-full p-4 space-y-8'>
        ...
        <Tabs defaultValue="rol-atama" className="w-[95vw] flex flex-col items-center justify-center p-4" >
          <TabsList className='bg-gray-200 p-2 py-6'>
            ...
            <TabsTrigger className='text-xl' value="gunluk" disabled={isPending}>Gunluk</TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="gunluk" className='flex gap-4'>
            <AreaChartComp data={gunlukTalepYaratma} chartLabel={'Gunluk Talep Yaratma'} quantityValue={'talepSayisi'} quantityLabel={'Talep Sayisi'} />
            <AreaChartComp data={gunlukImzaAtma} chartLabel={'Gunluk Imza Atma'} quantityValue={'imzaSayisi'} quantityLabel={'Imza Sayisi'} />
          </TabsContent>
