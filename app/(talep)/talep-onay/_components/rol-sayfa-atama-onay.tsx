...
export default function RolSayfaAtamaOnay({ data, previousKisiSayfaAtama }: Props) {

  const [gridData, setGridData] = useState<IWaitingRolSayfaAtama[]>(data);
  const [previousGrid, setPreviousGrid] = useState<IPreviousRolSayfaAtama[]>(previousKisiSayfaAtama);
