...
import { kisiSayfaEditPost, kisininSayfalar } from '@/actions/kisi-sayfa';
...
export default function KisiSayfaEditForm() {
  ...
  return (
    <CardWrapper backButtonHref="/talep-ekran" backButtonLabel="Talepler Sayfasına Geri Don" headerLabel="Kişi Sayfa Edit">
      <Form {...form}>
          ...
          <div className='grid grid-cols-2 gap-8'>
            ...
            <FormField control={form.control} name="sayfaRoute" render={({ field }) => (
              <FormItem>
                ...
                <CustomCombobox Options={sayfalarOptions} disabled={isPending || !isKisiSelected} onValueChange={(value) => { field.onChange(); onSayfaSelected(value) }} placeholder="Sayfa Ara" searchPlaceholder="Sayfa Ara..." />
              </FormItem>
            )} />
